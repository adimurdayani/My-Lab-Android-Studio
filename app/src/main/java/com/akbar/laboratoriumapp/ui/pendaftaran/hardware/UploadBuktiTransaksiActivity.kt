...
import com.akbar.laboratoriumapp.databinding.ActivityUploadBuktiTransaksiBinding
...
class UploadBuktiTransaksiActivity : AppCompatActivity() {
    private var _binding: ActivityUploadBuktiTransaksiBinding? = null
    private val binding get() = _binding!!
    private lateinit var s : SharedPref

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        _binding = ActivityUploadBuktiTransaksiBinding.inflate(layoutInflater)
    ...
    private fun simpan(file: File) {
        if (s.getStatusLogin()) {
            ...
            ApiConfig.instanceRetrofit.uploadTransaksi(user.nim, fileImage!!)
