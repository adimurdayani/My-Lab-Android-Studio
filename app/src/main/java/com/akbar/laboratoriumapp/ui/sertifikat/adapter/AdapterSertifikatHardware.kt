...
import com.akbar.laboratoriumapp.ui.sertifikat.detail.DetailNilaiSertifikatHardwareActivity
import com.akbar.laboratoriumapp.ui.sertifikat.detail.DetailNilaiSertifikatSoftwareActivity
import com.google.gson.Gson
import java.util.*
import kotlin.collections.ArrayList

class AdapterSertifikatHardware(val activity: Activity, private val data: ArrayList<Nilai>) :
    RecyclerView.Adapter<AdapterSertifikatHardware.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.btn_detail.setOnClickListener {
            ...
            val i = Intent(activity, DetailNilaiSertifikatHardwareActivity::class.java)
