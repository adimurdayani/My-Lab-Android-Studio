...
class DetailNilaiSertifikatSoftwareActivity : AppCompatActivity() {
    private var _binding: ActivityDetailNilaiSertifikatBinding? = null
    private val binding get() = _binding!!

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        _binding = ActivityDetailNilaiSertifikatBinding.inflate(layoutInflater)
    ...
    private fun setButton() {
        ...
        binding.btnDownload.setOnClickListener {
            val uri: Uri =
                Uri.parse("http://192.168.1.106/mylab/sertifikat/cetak_sertifikat_software/" + data.nim)
